 ...
 *
 * Disassembly of ssdt.aml, Mon Apr  8 22:10:13 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000942 (2370)
 *     Revision         0x01
 *     Checksum         0xB3
 *     OEM ID           "APPLE "
 *     OEM Table ID     "CpuPm"
...
DefinitionBlock ("", "SSDT", 1, "APPLE ", "CpuPm", 0x00021500)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version.....: 21.5 / Mac OS X 10.14 (18A347e)", Debug)
            Store ("custom mode...........: 0", Debug)
            Store ("host processor........: Intel(R) Core(TM) i7-5700HQ CPU @ 2.70GHz", Debug)
            Store ("target processor......: i7-5700HQ", Debug)
