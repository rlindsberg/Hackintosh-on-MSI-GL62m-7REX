 ...
 *
 * Disassembly of SSDT-9-OptTabl.aml, Tue Aug 28 22:51:07 2018
 *
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.PEG0.VEID, UnknownObj)    // (from opcode)
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    {
                        Store (Zero, \_SB.PCI0.LPCB.EC.QDXF)
                    }
                ...
                Case (0x20)
                {
                    ...
                    If (And (\_PR.HWPV, 0x00400000))
                    {
                        Or (RET1, 0x00800000, RET1)
                    }
                    Else
                    {
                        And (RET1, 0xFF7FFFFF, RET1)
                    }
                ...
                Case (0x22)
                {
                    ...
                    If (LGreaterEqual (\_SB.PCI0.LPCB.EC.PSNM, PCAP))
                    {
                        Store (\_SB.PCI0.LPCB.EC.PSNM, PCAP)
                    }
