 ...
 *
 * Disassembly of SSDT-3-PegSsdt.aml, Tue Aug 28 22:51:07 2018
 *
...
DefinitionBlock ("", "SSDT", 2, "PegSsd", "PegSsdt", 0x00001000)
{
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PEGS, 0, Serialized)
        {
            ...
            If (LEqual (And (CPEX, 0x0FFF0FF0), 0x000906E0))
            {
                If (LNotEqual (And (MODI, 0x06), 0x04))
                {
                    Store (One, Local0)
